...
- Cybernetics are installed on creatures (called the patient) by another creature (called the installer) or themselves.
	- If installed by another creature and the installer is a surgeon, the surgeon has advantage on a DC 13 wisdom (medical) check to install the part. 
	- If installed by another player and the installer is not a surgeon, the installer must make a DC 16 wisdom (medical) check to install the part. 
