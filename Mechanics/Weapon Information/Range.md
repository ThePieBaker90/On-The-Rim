...
tags:
  - Info
---
TODO REFACTOR INTO TWO TYPES OF RANGES!
Range is expressed in 3 numbers, the minimum-effective-range, the maxiumum-effective-range, and the maximum-range. To use these numbers, consider a target and an attacker. The target is the one being shot at, and the attacker is the one shooting.
