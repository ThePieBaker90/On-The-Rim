...
- Modifying effects that increase recoil are applied before effects that decrease recoil. Multiplicative and divisive effects are applied before additive and subtractive effects (to prevent ambiguity on order of operations).
## Example
