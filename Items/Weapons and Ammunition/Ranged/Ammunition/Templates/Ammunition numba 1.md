...
- Also include any restrictions for the use of this bullet, e.g. additional weapon or magazine restrictions not shared by the cartridge as a whole
  - Or, any restrictions of its use in combat such as range or environmental effects
 
## Cost
Always include a standard cost of the ammunition. There may be variation from time to time and place to place but this is the baseline. In general ammunition is never free though it might be extremely cheap.
