...
- **Duration**:
	- Instant.
- **Effects**:
	- You teleport a 15ft sphere centered on the initial point. Any creature within the sphere with enough remaining [[Movement|Movement Speed]] to reach the edge of the sphere may make a dexterity saving throw. 
